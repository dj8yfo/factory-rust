...
const DONATION_DEFAULT_CONTRACT: &[u8] = include_bytes!(env!("BUILD_RS_SUB_BUILD_ARTIFACT"));
...
impl Default for Contract {
    fn default() -> Self {
        Self {
            code: LazyOption::new("code".as_bytes(), Some(DONATION_DEFAULT_CONTRACT.to_vec())),
        }
    }
}
